       ...
       <View className="flex-row items-center mt-6">
        ...
        <View className="mt-5 justify-center w-[60%]">
          ...
          <View className="w-full flex flex-col mt-12 gap-8 justify-center">
            ...
            <TextInput placeholder="e.g John Doe" className="border border-slate-300 px-10 py-3 rounded-full shadow-sm bg-slate-100"/>
            <Ionicons name="person" size={18} color={"gray"}  className="top-[54%] left-3 absolute"/>
            </View>
            <View className="relative">
            <Text className="font-robotoSemiBold px-2 mb-2">Email</Text>
            <TextInput placeholder="e.g JohnDoe@gmail.com" className="border border-slate-300 px-10 py-3 rounded-full shadow-sm bg-slate-100"/>
            <Ionicons name="mail" size={18} color={"gray"}  className="top-[54%] left-3 absolute"/>
            </View>
            <View className="relative">
              <Text className="font-robotoSemiBold px-2 mb-2">Password</Text>
              <TextInput placeholder="••••••••••••••••" className="border border-slate-300 px-10 py-3 rounded-full shadow-sm bg-slate-100" secureTextEntry={showPassword}/>
              <Pressable className="absolute right-3 top-[52%]" onPress={() => setShowPassword(prev => !prev)}>
                {
                  showPassword ? (<Ionicons name="eye" size={22} color={"gray"} />): (<Ionicons name="eye-off" size={22} color={"gray"} />)
                }
              </Pressable>
              <Ionicons name="lock-open" size={18} color={"gray"}  className="top-[60%] left-3 absolute"/>
            </View>
            <Link href="/" className="text-right mt-2">
            <Text className="text-blue-500 font-montserratBold">Forgot Password?</Text>
            </Link>
          </View>
        </View>
        ...
        <View className="flex-row mt-6">
          ...
          <Link href="/login">
            <Text className="text-success-green font-robotoSemiBold">Log in</Text>
          </Link>
        </View>
      </View>
    </View>
