       ...
       <View className="flex-row items-center mt-6">
        ...
        <View className="mt-5 justify-center w-[60%]">
          ...
          <View className="w-full flex flex-col mt-12 gap-1 justify-center">
            ...
            <TextInput placeholder="e.g JohnDoe@gmail.com" className="border border-slate-300 px-4 py-3 rounded-full shadow-sm bg-white"/>
            <View className="relative">
              <Text className="font-robotoSemiBold px-2 mt-4">Password</Text>
              <TextInput placeholder="••••••••••••••••" className="border border-slate-300 px-4 py-3 rounded-full shadow-sm bg-white" secureTextEntry={showPassword}/>
